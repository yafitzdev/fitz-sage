# fitz_sage/ingestion/enrichment/modules/__init__.py
"""
...
from fitz_sage.ingestion.enrichment.modules.base import ChatClient, EnrichmentModule
from fitz_sage.ingestion.enrichment.modules.chunk import (
    EntityModule,
    KeywordModule,
    SummaryModule,
)
