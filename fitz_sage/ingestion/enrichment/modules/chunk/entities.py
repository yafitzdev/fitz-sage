# fitz_sage/ingestion/enrichment/modules/chunk/entities.py
...
from fitz_sage.ingestion.enrichment.modules.base import EnrichmentModule
from fitz_sage.ingestion.enrichment.prompts import load_chunk_prompt
