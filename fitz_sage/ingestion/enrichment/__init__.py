# fitz_sage/ingestion/enrichment/__init__.py
"""
...
# Artifact components
from fitz_sage.ingestion.enrichment.artifacts import (
    Artifact,
    ArtifactGenerator,
    ArtifactType,
    ProjectAnalysis,
...
# Base types
from fitz_sage.ingestion.enrichment.base import (
    ContentType,
)

# Chunk enrichment bus
from fitz_sage.ingestion.enrichment.bus import (
    ChunkEnricher,
...
# Models
from fitz_sage.ingestion.enrichment.models import (
    EnrichmentResult,
)
...
from fitz_sage.ingestion.enrichment.pipeline import (
    EnrichmentPipeline,
)

# Registry
from fitz_sage.ingestion.enrichment.registry import (
    DEFAULT_MODULES,
    get_default_modules,
    get_module_by_name,
