# fitz_sage/ingestion/chunking/router.py
"""
...
from fitz_sage.ingestion.chunking.registry import (
    get_chunker_for_extension,
    get_chunking_plugin,
)
from fitz_sage.ingestion.exceptions.chunking import IngestionChunkingError
