...
from fitz_sage.ingestion.diff.differ import Differ, FileCandidate
from fitz_sage.ingestion.diff.scanner import FileScanner
from fitz_sage.ingestion.hashing import compute_chunk_id
from fitz_sage.ingestion.parser.router import ParserRouter
from fitz_sage.ingestion.source.base import SourceFile
from fitz_sage.ingestion.state.manager import IngestStateManager
from fitz_sage.tabular import TableExtractor

if TYPE_CHECKING:
    from fitz_sage.ingestion.enrichment.pipeline import EnrichmentPipeline
    from fitz_sage.tabular.store.base import TableStore
...
class DiffIngestExecutor:
    ...
    def _detect_vocabulary(self, prepared_files: List[tuple]) -> None:
        ...
        """
        try:
            from fitz_sage.retrieval.vocabulary import KeywordDetector, VocabularyStore
    ...
    def _build_sparse_index(
        ...
        """
        try:
            from fitz_sage.retrieval.sparse import SparseIndex
