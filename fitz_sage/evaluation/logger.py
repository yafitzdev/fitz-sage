# fitz_sage/evaluation/logger.py
"""
...
import fitz_sage
from fitz_sage.evaluation.schema import ensure_schema
from fitz_sage.governance import GovernanceDecision, GovernanceLog
from fitz_sage.logging.logger import get_logger
from fitz_sage.logging.tags import GOVERNANCE

if TYPE_CHECKING:
    from psycopg_pool import ConnectionPool

    from fitz_sage.core import Chunk
...
class GovernanceLogger:
    ...
    def __init__(
        ...
        self.pipeline_version = pipeline_version or fitz_sage.__version__
