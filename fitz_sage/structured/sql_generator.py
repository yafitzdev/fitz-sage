# fitz_sage/structured/sql_generator.py
"""
...
from fitz_sage.structured.constants import MAX_QUERIES_PER_REQUEST, MAX_RESULT_NAMES
from fitz_sage.structured.schema import TableSchema
