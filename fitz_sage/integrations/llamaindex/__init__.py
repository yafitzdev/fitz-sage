# fitz_sage/integrations/llamaindex/__init__.py
"""LlamaIndex integration for Fitz Cloud optimization.

Install with: pip install fitz-sage[llamaindex]

Example:
    >>> from llama_index.core import VectorStoreIndex
    >>> from llama_index.embeddings.openai import OpenAIEmbedding
    >>> from llama_index.llms.openai import OpenAI
    >>> from fitz_sage.integrations.llamaindex import FitzQueryEngine
    >>>
    >>> # Your existing setup
...
try:
    from fitz_sage.integrations.llamaindex.query_engine import FitzQueryEngine
