# fitz_sage/integrations/base.py
...
from fitz_sage.cloud.cache_key import CacheVersions, compute_retrieval_fingerprint
from fitz_sage.cloud.client import INDEXED_EMBEDDING_DIMS, CloudClient
...
class FitzOptimizer:
    ...
    def __init__(
        ...
        base_url: str = "https://api.fitz-sage.cloud/v1",
