# fitz_sage/governance/constraints/feature_extractor.py
"""
...
from fitz_sage.governance.constraints.plugins.specific_info_type import SpecificInfoTypeConstraint
