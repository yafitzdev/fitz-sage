# tools/smoketest/smoke_fitz_rag_e2e.py
"""
End-to-End Smoketest for Fitz RAG Engine.

Tests the complete Fitz RAG pipeline with mocked external services:
...
Usage:
    python tools/smoketest/smoke_fitz_rag_e2e.py
    python tools/smoketest/smoke_fitz_rag_e2e.py --with-files ./test_docs
    python tools/smoketest/smoke_fitz_rag_e2e.py --verbose
"""
...
def main() -> int:
    """Main entry point."""
    parser = argparse.ArgumentParser(description="End-to-end smoketest for Fitz RAG engine")
    parser.add_argument(
        "--with-files",
        type=Path,
