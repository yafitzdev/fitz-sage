...
```python
from fitz import run
from fitz.runtime import list_engines, create_engine

# Discover available engines
print(list_engines())  # ['classic_rag', 'clara']
...
|--------|-------------|--------|
| `classic_rag` | Traditional RAG | ✅ Production |
| `clara` | CLaRa compression-native RAG | ✅ Available |
| `graphrag` | Knowledge graph RAG | 🔜 Planned |
...
# Simple query (uses classic_rag by default)
...
### CLaRa vs Classic RAG

| Metric | Classic RAG | CLaRa |
|--------|-------------|-------|
